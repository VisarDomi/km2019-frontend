    ...
    <div class="blog-page">
      ...
      <div class="row blog-row">
        <div class="col-md-5 col-12 image-col">
          <img class="blog-image" src="@/assets/img/blog/Blog-14.jpg" alt />
        </div>
        <div class="col-md-7 col-xs-12 blog-col">
          <div class="container">
            ...
            <p class="blog-content" v-if="this.lang == 'en'">
              Elia Shena has imitated in the program "E Diela Shqiptare" singers Samanta Karavella and Albërie Hadërgjonaj. Samanta had texted Elia on Whatsapp “Do you dare to imitate me?”, while Elia accepted the challenge by imitating not only Samanta but Albërie Hadërgjonaj as well. Time will tell if these artists will hold grudges against Elia. She has returned to Kënga Magjike festival after a long absence in the field of music.
            </p>
            <p class="blog-content" v-else>
              Elia Shena ka imituar në programin “ E Diela Shqiptare” këngëtaret Samanta Karavella dhe Albërie Hadërgjonaj. “A ta mban të më imitosh në publik?” ishte pyetja që Samanta i kishte nisur në WhatsApp, ndërsa Elia e pranoi sfidën duke imituar jo vetëm Samantën por edhe Albërie Hadërgjonaj. Tani na mbetet të shohim nëse dy artistet do ti mbajnë a jo mëri Elias për këtë imitim. Ajo është rikthyer në festivalin “Kënga Magjike” pas një mungese të gjatë në fushën e muzikës. 
            </p>
            <div class="row">
    ...
    meta: [
      {
        p: "og:image",
        c:
          "https://previews.dropbox.com/p/thumb/AAmwlzx16GEsXktk4jZ3tr9WGFR7Gyx3UHq9o1bfCQvnMgUxayEAkyQy_KK5FT6T3mnKyDT3dLB1kWRJWTGAUdjKnvfWsRnxpzKkENbL7xX5DcI9q8IrFkqgnwMshbt1lVYza8S1vQC_aw9SCcDiGqO0bDrojeKxemOEOqaltUZuSdPSppw5RPnKn5yaRs70opObnELLfK0jHlM1rfPD6UZexbA3TrzXK9UBVq0fWV2uQpWRZQ-zkVxQXp_T2hTMkLCCOFtfD8Y5WVOw5VvdSkKmmyej6Q9fpeCshdcDHUrHDDK9qkZpaNDFnppwzTXHGUwdtqKJnMQWfi1qoqy6RoOqTKdZHtchAc0fTS9LKgMxdg/p.jpeg?fv_content=true&size_mode=5"
      },
      {
        p: "og:url",
        c: "https://kengamagjike.com/blog14"
      },
      {
        p: "og:title",
        c: "Elia i imiton. A do ti mbajnë mëri Samanta Karavella dhe Albërie Hadërgjonaj?"
      },
      {
        p: "og:description",
        c:
          "Elia Shena ka imituar në programin “ E Diela Shqiptare” këngëtaret Samanta Karavella dhe Albërie Hadërgjonaj."
      }
    ]
  },
  methods: {
