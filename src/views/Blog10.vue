...
export default {
  ...
  head: {
    ...
    meta: [
      ...
      { p: "og:url", c: "https://kengamagjike.com/blog10" },
      {
        p: "og:title",
        c: "Rea Nuhu gjen në “E Diela Shqiptare” veshjet e babait..."
      },
      {
        p: "og:description",
        c: "Kthehet për të tretin vit rradhazi në Kënga Magjike, Rea Nuhu. "
      }
    ]
  },
  methods: {
