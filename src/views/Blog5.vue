  ...
  <div class="blog-page">
    ...
    <div class="row blog-row">
      ...
      <div class="col-md-7 col-xs-12 blog-col">
        <div class="container">
          <h1 class="single-blog-title">Mishela Rrapo: Presidenti turk u përlot prej meje</h1>
          <hr />
          <p
            class="blog-content"
          >Mishela rrapo ka prezantuar këtë të dielë këngën e saj në edicionin e 20-të të Këngës Magjike. Mishela
në bashkëpunim më Ergys Shahun iu përgjigjën pyetjeve të minintervistës ndërsa këngëtarja solli në
vëmëndje dashurinë e saj për turqinë duke e lidhur edhe me emocionin e veçantë që kishte provuar në
këtë vend kur në 2011 ishte pritur personalisht nga ish-presidenti turk, Sulejman Demirel. Aho tha se
kishte kënduar para tij një këngë ndërsa ky i fundit ishte përlotur nga zëri i Mishel.

          <div class="row">
            <p class="single-date">12.10.2018</p>
