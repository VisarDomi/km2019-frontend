  ...
  <div class="blog-page">
    ...
    <div class="row blog-row">
      <div class="col-md-5 col-12 image-col">
        <img
          class="blog-image"
          src="@/assets/img/blog/Blog-fifi.jpg"
          alt
        />
      </div>
      <div class="col-md-7 col-xs-12 blog-col">
        <div class="container">
          <h1 class="single-blog-title">Fifi, nje imituese perfekte!</h1>
          <hr />
          <p
            class="blog-content"
          >Te gjithe e njohin karakterin e saj te paparashikueshem. Behet fjale per kengetaren Fifi, e cila edhe perse u vu ne nje prove te veshtire ku i duhej te improvizonte situata nga me te ndryshmet, ja doli. ''Fati'' i kartave, vendosi qe ajo te imitonte disa nga kengetaret me te suksesshme te momentit.
          ...
          <div class="row">
            ...
            <div class="carousel-right" @mouseover="hoverR = true" @mouseleave="hoverR = false">
              <img
                ...
                alt
              />
              <img v-else @click="goToBlog('Blog8')" src="@/assets/img/buttons_export/button_tereja_right.svg" style="width:6rem;" alt />
            </div>
            ...
            <div class="carousel-left" @mouseover="hoverL = true" @mouseleave="hoverL = false">
              <img
                ...
                alt
              />
              <img v-else @click="goToBlog('Blog6')" src="@/assets/img/buttons_export/button_tereja_left.svg" style="width:6rem;" alt />
            </div>
          </div>
