    ...
    <div class="blog-page">
      ...
      <div class="row blog-row">
        <div class="col-md-5 col-12 image-col">
          <img class="blog-image" src="@/assets/img/blog/Blog-17.jpg" alt />
        </div>
        <div class="col-md-7 col-xs-12 blog-col">
          <div class="container">
            ...
            <p
              class="blog-content"
              v-else
            >Rovena Dilo e konsideron çdo femër me personalitet një DIVA. Gjatë prezantimit në “Kënga Magjike”, Dilo i është rikthyer edhe njëherë koncertit të mbajtur në 2018 “Diva Show”. E “provokuar” nga një mesazh në Whtasapp nga Elsa Lila që e ftonte për një “DIVA 2”, Dilo tha se ideja e saj për koncertin e parë ishte promovimi i femrës dhe se koncerti është bërë për të përfaqësuar çdo femër. Rovena Dilo konkurron në “Kënga Magjike 2019” me këngën “Cinderella” që është një bashkëpunim me Hit Man & Rolla.</p>
            <div class="row">
    ...
    meta: [
      {
        p: "og:image",
        c:
          "https://s3.eu-west-1.amazonaws.com/kengamagjike2019/blogIimages%2F%2F6tetorlajmi1.jpg"
      },
      {
        p: "og:url",
        c: "https://kengamagjike.com/blog17"
      },
      {
        p: "og:title",
        c: "Rovena Dilo: Çdo femër me personalitet është DIVA..."
      },
      {
        p: "og:description",
        c: "Rovena Dilo e konsideron çdo femër me personalitet një DIVA..."
      }
    ]
  },
  methods: {
