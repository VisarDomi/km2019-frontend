    ...
    <div class="blog-page">
      ...
      <div class="row blog-row">
        <div class="col-md-5 col-12 image-col">
          <img class="blog-image" src="@/assets/img/blog/Blog-15.jpg" alt />
        </div>
        <div class="col-md-7 col-xs-12 blog-col">
          <div class="container">
            ...
            <p class="blog-content" v-if="this.lang == 'en'">
              Can you believe that a 2-year-old child is capable of counting up to 10 in four foreign languages? Believe it or not but this is best done by Korab Shaqiri's son, Alteu, and of course he as a father did not hide his pride in his son. In the show "E Diela Shqiptare", Korab Shaqiri said that his son has learned to count in four foreign languages just by listening to children's songs on YouTube. Korab Shaqiri returns after 11 years in Kënga Magjike where he competes with the song "Fenomen".
            </p>
            <p class="blog-content" v-else>
              A mund ta besoni se një fëmijë 2-vjeccar është i aftë të numërojë deri në 10 në katër gjuhë të huaja? Besojeni ose jo por këtë e bën më së miri djali i Korab Shaqirit, Alteu, dhe sigurisht ai si baba nuk e fshehu krenarinë për të birin. Në emisionin "E Diela Shqiptare", Korab Shaqiri tha se djali i tij ka mësuar të numërojë në katër gjuhë të huaja vetëm duke dëgjuar këngë për fëmijë në YouTube. Korab Shaqiri rikthehet pas 11 vitesh në "Kënga Magjike" ku konkurron me këngën "Fenomen". 
            </p>
            <div class="row">
    ...
    meta: [
      {
        p: "og:image",
        c:
          "https://previews.dropbox.com/p/thumb/AAl3pQQ8kLg0uQYfak9i8oMnrl3i4DkuUy3p62f5HnU94h_rGjza3r4ZscHkvVxJfqEzArfHtI3e0eOuxD3CofRAbyJNDZeX6avTuFUU6QOLis2LOCoQcSpzQsKQcMMfNr2RDEBF4uqZC_sArBLjto0H3I8t4ujXt92FMiXr5IXhan9HfD7Dac3kS8csH-8FmHvsRzlSXPwuRq50G_EXhFzt0fX0oQYRP1GkbXsWtG2ljFtl5kNd0b29XRP7muPGkbU2m1U_M2ZkHHdAt4Y5Tz9gmny4c6ya6ioWcB2OhrsHp1OAW6jZmOo9SsDM7dNAA74M1X9dRARegKD8pdUs-isRB7kfPlHSotjREXy7hwVKaQ/p.jpeg?fv_content=true&size_mode=5"
      },
      {
        p: "og:url",
        c: "https://kengamagjike.com/blog15"
      },
      {
        p: "og:title",
        c: "Djali i Korab Shaqirit \"Fenomen\""
      },
      {
        p: "og:description",
        c:
          "A mund ta besoni se një fëmijë 2-vjeccar është i aftë të numërojë deri në 10 në katër gjuhë të huaja?"
      }
    ]
  },
  methods: {
