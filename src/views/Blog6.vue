  ...
  <div class="blog-page">
    ...
    <div class="row blog-row">
      ...
      <div class="col-md-7 col-xs-12 blog-col">
        <div class="container">
          <h1 class="single-blog-title">Evi Reçi nuk dua binjake!!</h1>
          <hr />
          <p
            class="blog-content"
          >E dinit qe Evi Reçi nuk mund te shikoje binjake!? <br>
“Me hapin nje ndjesi te cuditshme. Si mundet qe dy njerez te ngjajne si dy pika uji!?”, eshte shprehur ajo ne interviste me Ardit Gjebrean. <br>
“Nuk dua te kem moter binjake! Nuk dua te lind binjake! Nuk dua te martohem me dike qe ka nje binjak identik! “ <br>
Me e qarte se kaq....
          ...
          <div class="row">
            ...
            <div class="carousel-right" @mouseover="hoverR = true" @mouseleave="hoverR = false">
              <img
                ...
                alt
              />
              <img v-else @click="goToBlog('Blog7')" src="@/assets/img/buttons_export/button_tereja_right.svg" style="width:6rem;" alt />
            </div>
            ...
            <div class="carousel-left" @mouseover="hoverL = true" @mouseleave="hoverL = false">
              <img
                ...
                alt
              />
              <img v-else @click="goToBlog('Blog5')" src="@/assets/img/buttons_export/button_tereja_left.svg" style="width:6rem;" alt />
            </div>
          </div>
