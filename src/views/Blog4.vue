  ...
  <div class="blog-page">
    ...
    <div class="row blog-row">
      ...
      <div class="col-md-7 col-xs-12 blog-col">
        <div class="container">
          <h1 class="single-blog-title">Atmosferë serenatash në skenën e Këngës Magjike</h1>
          <hr />
          <p
            class="blog-content"
          >Klajdi Haruni ka sjellë një atmosferë ndryshe në skenën e këngës magjike i shoqëruar nga grupi i
kitaristëve. Një këngë plot ritëm e sjellë këtë herë nga Klajdi për dikë të cilin s’mund ta dojë dot më pak.
          ...
          <div class="row">
            ...
            <div class="carousel-right" @mouseover="hoverR = true" @mouseleave="hoverR = false">
              <img
                ...
                alt
              />
              <img v-else @click="goToBlog('Blog5')" src="@/assets/img/buttons_export/button_tereja_right.svg" style="width:6rem;" alt />
            </div>
            ...
            <div class="carousel-left" @mouseover="hoverL = true" @mouseleave="hoverL = false">
              <img
                ...
                alt
              />
              <img v-else @click="goToBlog('Blog3')" src="@/assets/img/buttons_export/button_tereja_left.svg" style="width:6rem;" alt />
            </div>
          </div>
