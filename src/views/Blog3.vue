  ...
  <div class="blog-page">
    ...
    <div class="row blog-row">
      ...
      <div class="col-md-7 col-xs-12 blog-col">
        <div class="container">
          <h1 class="single-blog-title">Fifi dhe Mc Kresha betejë në skenë!</h1>
          <hr />
          <p
            class="blog-content"
          >Dy këngëtarët e njohur Fifi dhe Mc Kresha vijnë këtë herë me një duet në Këngën magjike. Ndryshe nga
artistët e tjerë që në skenë janë sprovuar me pyetje apo situata pikante, Fifi dhe Kresha sollën përpara
publikut një Rap Battle duke shpalosur gjithë talentin e tyre.

          <div class="row">
            <p class="single-date">18.11.2018</p>
            <div class="carousel-right" @mouseover="hoverR = true" @mouseleave="hoverR = false">
              <img
                ...
                alt
              />
              <img v-else @click="goToBlog('Blog4')" src="@/assets/img/buttons_export/button_tereja_right.svg" style="width:6rem;" alt />
            </div>
            ...
            <div class="carousel-left" @mouseover="hoverL = true" @mouseleave="hoverL = false">
              <img
                ...
                alt
              />
              <img v-else @click="goToBlog('Blog2')" src="@/assets/img/buttons_export/button_tereja_left.svg" style="width:6rem;" alt />
            </div>
          </div>
