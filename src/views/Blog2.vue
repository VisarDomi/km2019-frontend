    ...
    <div class="row blog-row">
      ...
      <div class="col-md-7 col-xs-12 blog-col">
        <div class="container">
          ...
          <p
            class="blog-content"
          >Mbrëmjen e djeshme u zhvillua nata finale e "Kënga Magjike". Kanë qenë vetë artistët ata që kanë përzgjedhur 20-finalistet dhe këngën fituese.
<br><br>
Eshtë pikërish kantautori Flori Mumajesi me këngën "Plas" i cili ka fituar vendin e parë.

          <div class="row">
            <p class="single-date">16.01.2018</p>
            <div class="carousel-right" @mouseover="hoverR = true" @mouseleave="hoverR = false">
              <img
                ...
                alt
              />
              <img v-else @click="goToBlog('Blog3')" src="@/assets/img/buttons_export/button_tereja_right.svg" style="width:6rem;" alt />
            </div>
            ...
            <div class="carousel-left" @mouseover="hoverL = true" @mouseleave="hoverL = false">
              <img
                ...
                alt
              />
              <img v-else @click="goToBlog('Blog1')" src="@/assets/img/buttons_export/button_tereja_left.svg" style="width:6rem;" alt />
            </div>
          </div>
