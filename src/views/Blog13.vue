    ...
    <div class="blog-page">
      ...
      <div class="row blog-row">
        <div class="col-md-5 col-12 image-col">
          <img class="blog-image" src="@/assets/img/blog/Blog-13.jpg" alt  />
        </div>
        <div class="col-md-7 col-xs-12 blog-col">
          <div class="container">
            ...
            <p class="blog-content" v-if="this.lang == 'en'">
              A difficult moment that has passed a short time ago, has led Erik Lloshi to write all the experience of that situation by bringing to Kënga Magjike, a song created and composed by himself. "Trishtimin Kisha" is the name of the song which Erik Lloshi competes for the seventh time at the festival. He also brought on stage instrumentalists who accompanied him during the song presentation, while he himself played the piano.
            </p>
            <p class="blog-content" v-else>
              Një moment i vështirë që e ka kaluar pak kohë më parë, ka bërë që Erik Lloshi të hedhë në letër gjithë përjetimin e asaj situate duke sjellë kështu në "Kënga Magjike", një këngë të krijuar dhe kompozuar nga vetë ai. "Trishtimin kisha" është kënga me te cilën Erik Lloshi konkurron për herë të shtatë në festival. Ai solli në skenë edhe instrumentistë që e shoqëruan gjatë prezantimit të këngës, ndërsa ai vetë luajti në piano.
            </p>
            <div class="row">
    ...
    meta: [
      {
        p: "og:image",
        c:
          "https://previews.dropbox.com/p/thumb/AAkfxwbsNdg-jdCvW8YeFtFTaczFDx2P422WCP_TV2FsW1N9XDuJvR6z3dlIDRqV3Wb2pZezW5B-sS3bo3qZTqlCJefqjIEWd8U73UTLyLyCzMJfr7lwSUVIt8US8UR01EKbUjhbE8Pr7MXsXBd_ttc33OI_jZtA1b-lVS3RCDcILxYjRvlX5R2H95sTSVMRAS9g0uPy9p3fxLm7k3x-2WQxwqJwGaYVbyIlyW77RqJuxvJWWjB_PHFLzxdZ4JWVludRPzdWio3wOJpXdT2UVL6o8Y9dSQcwFQLgYUifUhqammCV3NHu5rRXD1OsErGZy8ca-qM9QAs35R5bV8z0ggNtBbMy5SCcoNtACP7RY5uikA/p.jpeg?fv_content=true&size_mode=5"
      },
      {
        p: "og:url",
        c: "https://kengamagjike.com/blog13"
      },
      {
        p: "og:title",
        c: "Erik Lloshi: Momenti i vështirë i jetës sime"
      },
      {
        p: "og:description",
        c:
          "Një moment i vështirë që e ka kaluar pak kohë më parë, ka bërë që Erik Lloshi të hedhë në letër gjithë përjetimin e asaj situate duke sjellë kështu..."
      }
    ]
  },
  methods: {
