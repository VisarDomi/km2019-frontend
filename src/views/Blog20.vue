    ...
    <div class="blog-page">
      ...
      <div class="row blog-row">
        <div class="col-md-5 col-12 image-col">
          <img class="blog-image" src="@/assets/img/blog/Blog-20.jpg" alt />
        </div>
    ...
    meta: [
      {
        p: "og:image",
        c:
          "https://s3.eu-west-1.amazonaws.com/kengamagjike2019/blogIimages%2F%2F6tetorlajmi4.jpg"
      },
      {
        p: "og:url",
        c: "https://kengamagjike.com/blog20"
      },
      {
        p: "og:title",
        c: "Java 3, kalojnë fazën e parë dy New Artist"
      },
      {
        p: "og:description",
        c:
          "Donat Makolli dhe Glejvis janë dy artistët e rinj që kanë arritur të bindin jurinë e New Artist...."
      }
    ]
  },
  methods: {
